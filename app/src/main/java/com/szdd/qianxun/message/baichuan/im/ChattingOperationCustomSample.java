            ...
            if (item.getItemId() == ITEM_ID_1) {
                ...
                if (phone == null || phone.equals("")) {
                    ...
                    Intent phoneIntent = new Intent(Intent.ACTION_DIAL,
                            Uri.parse("tel:" + phone));
                    phoneIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    pointcut.getActivity().startActivity(phoneIntent);
                }
                ...
                if (phone == null || phone.equals("")) {
                    ...
                    Intent mIntent = new Intent(android.content.Intent.ACTION_SENDTO,
                            smsToUri);
                    pointcut.getActivity().startActivity(mIntent);
                }
            }
        }
    }
...
//        return null;
    ...
    public static void sendGeoMessage(final YWConversation conversation) {
        StaticMethod.Location(QianxunApplication.getContext(), new LocationListener() {
            @Override
