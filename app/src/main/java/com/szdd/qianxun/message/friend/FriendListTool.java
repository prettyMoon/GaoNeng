...
public class FriendListTool {
    ...
    public static void addOneFriend(Context context, int id, long username) {
        addOneFriend(context, id, username, null);
    }

    public static void addOneFriend(Context context, int id, long username, String nickname) {
