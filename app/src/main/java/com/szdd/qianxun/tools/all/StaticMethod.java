...
import com.szdd.qianxun.alipay.AlipayEasy;
...
public class StaticMethod {
    ...
    public static void UBITMAP(String url, ImageView view) {
        com.nostra13.universalimageloader.core.
                ImageLoader.getInstance().displayImage(url, view, MainMain.mOptions);
    }
    ...
    public static void UBITMAPHEAD(final String url, final ImageView img_view) {
        com.nostra13.universalimageloader.core.
                ImageLoader.getInstance().displayImage(url, img_view, MainMain.mHeadOptions);
    }
