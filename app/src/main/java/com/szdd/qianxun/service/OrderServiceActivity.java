...
import com.szdd.qianxun.alipay.AlipayBuilder;
import com.szdd.qianxun.alipay.AlipayListener;
...
public class OrderServiceActivity extends Activity implements View.OnClickListener {
            ...
            case R.id.order_service_btn_submit:
                if (alipay_name.getText().toString().isEmpty()) showToast("请填写真实姓名");
                    ...
                    if (isDialogClicked) {
                        ...
                        SercuityDialog dialog = new SercuityDialog(OrderServiceActivity.this);
    ...
    private void pay(int ugsId) {
         ...
         */
        StaticMethod.PAY(this, new AlipayBuilder(String.valueOf(ugsId), tv_servicename.getText().toString()
    ...
    public void AnalyData(String str) {
        ...
        if (str == null) {
            ...
            try {
                ...
                if (jsonObject.getString("reward_money").equals("") || jsonObject.getString("reward_unit").equals("")) {
