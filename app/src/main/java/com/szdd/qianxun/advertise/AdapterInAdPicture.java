...
//        setAnimation(pv.frame, i);
        ...
        ImageLoader.getInstance().displayImage(picture_url, pv.btn_image, MainMain.mOptions);
        ImageLoader.getInstance().displayImage(user_icon_url, pv.head, MainMain.mHeadOptions);
        //添加监听器
