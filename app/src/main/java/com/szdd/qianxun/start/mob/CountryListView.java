...
import com.szdd.qianxun.start.mob.GroupListView.OnItemClickListener;
...
public class CountryListView extends RelativeLayout implements OnTouchListener {
	...
	private void init(Context context) {
		...
		tvScroll.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(80));
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN: {
			int resId = getBitmapRes(v.getContext(),
					"smssdk_country_group_scroll_down");
			if (resId > 0) {
