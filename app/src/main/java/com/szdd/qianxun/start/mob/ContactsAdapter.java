...
import com.szdd.qianxun.start.mob.ContactsListView.GroupAdapter;
import com.szdd.qianxun.start.mob.layout.SizeHelper;
...
public class ContactsAdapter extends GroupAdapter {
	...
	public ContactsAdapter(ContactsListView view,
			ArrayList<HashMap<String, Object>> friendsInApp,
	...
	private void reSortFia(HashMap<String, String> resMap,
			boolean isEmptyToken, ArrayList<HashMap<String, Object>> data) {
		...
		if (list.size() > 0) {
			int resId = getStringRes(view.getContext(),
					"smssdk_contacts_in_app");
			if (resId > 0) {
	...
	private void reSortFoa(HashMap<String, String> resMap,
			boolean isEmptyToken, ArrayList<HashMap<String, Object>> data) {
		ArrayList<HashMap<String, Object>> list = new ArrayList<HashMap<String, Object>>();
		for (HashMap<String, Object> contact : data) {
			String name = "";
	...
	// /** 数据处理 */
	// private void reSortFia(String token, ArrayList<HashMap<String, Object>>
	// data) {
	...
	//
	// /** 数据处理 */
	// private void reSortFoa(String token, ArrayList<HashMap<String, Object>>
	// data) {
	// boolean isEmptyToken = TextUtils.isEmpty(token);
	// ArrayList<HashMap<String, Object>> list = new ArrayList<HashMap<String,
	// Object>>();
	...
	public TextView getTitleView(int group, TextView convertView,
			ViewGroup parent) {
		if (convertView == null) {
			...
			convertView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
	...
	public View getView(final int group, final int position, View convertView,
			ViewGroup parent) {
