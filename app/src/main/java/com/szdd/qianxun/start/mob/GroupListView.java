...
public class GroupListView extends RelativeLayout {
	...
	private void init(Context context) {
		...
		lvBody.setOnScrollListener(new OnScrollListener() {
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				if (osListener != null) {
					osListener.onScroll(view, firstVisibleItem,
		...
		lvBody.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View view,
				...
				if (oicListener != null) {
					...
					int item = position - innerAdapter.titleIndex.get(group)
							- 1;
					oicListener.onItemClick(GroupListView.this, view, group,
							item);
				}
			}
		});
		lvBody.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
	...
	private static class InnerAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (isTitle(position)) {
				if (convertView != null) {
					convertView = adapter.getTitleView(group, convertView,
							parent);
				} else {
	...
	public static abstract class GroupAdapter {
		 ...
		 * @return
		 */
		public abstract View getTitleView(int group, View convertView,
				ViewGroup parent);
